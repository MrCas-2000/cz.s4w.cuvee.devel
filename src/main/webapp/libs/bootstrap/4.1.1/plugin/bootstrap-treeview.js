;(function ($, window, document, undefined) {
		...
		$.each(nodes, function addNodes(id, node) {
			...
			*/
			...
			if (_this.options.showIcon) {
				...
				if (node.image) {
					treeItem.append('<span style="margin-right:4px;"><img src="' + node.image + '" width="16px" height="16px"><span>');
				} else {
					treeItem.append($(_this.template.icon).addClass(classList.join(' ')));
				}
			}
	...
	Tree.prototype.template = {
		...
		image: '<img src="" width="16px" height="16px"></img>',
		link: '<a href="#" style="color:inherit;"></a>',
		badge: '<span class="badge"></span>'
	};

	Tree.prototype.css = '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:10px;margin-right:10px}.treeview span.icon{width:20px;margin-right:0px}.treeview .node-disabled{color:silver;cursor:not-allowed}'
