(function (f, define) {
    define('suix.upload', ['suix.core'], f);
}(function () {
    var __meta__ = {
        id: 'upload',
        name: 'Upload',
    ...
    (function ($, undefined) {
        ...
        var Upload = Widget.extend({
            ...
            _removeFileByUid: function (uid, shouldSendRemoveRequest) {
                ...
                fileEntry = $('.k-file[' + suix.attr('uid') + '="' + uid + '"]', that.wrapper);
            ...
            _addInput: function (sourceInput) {
                ...
                input.insertAfter(that.element).data('suix' + that.options.prefix + that.options.name, that);
            ...
            _onInputKeyDown: function (e) {
                ...
                if (e.keyCode === suix.keys.TAB && firstButton.length > 0 && !e.shiftKey) {
                    e.preventDefault();
                    firstButton.focus();
                }
            },
            ...
            _prepareDefaultSingleFileEntryTemplate: function (data) {
                ...
                var fileGroup = suix.getFileGroup(file.extension, true);
            ...
            _enqueueFile: function (name, data) {
                ...
                fileEntry.attr(suix.attr('uid'), fileUid).appendTo(fileList).data(data);
                if (!that._async) {
            ...
            _supportsMultiple: function () {
                ...
                return !suix.support.browser.opera && !(suix.support.browser.safari && windows);
            },
